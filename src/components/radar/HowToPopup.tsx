  ...
  return (
        <Popover trigger={'hover'}>
          ...
          <PopoverContent className="popoverContent">
            <PopoverHeader><h1>How to use the DRR Technology Radar</h1></PopoverHeader>
            <PopoverBody >
              ...
              <div className="timeline">
                <div className="container">
                  <div className="content">
                    ...
                    <Image m={5} src={Blip}/>
                    <p>Click (or hover) on the rounded blips on the radar to view the summary of each technology item.</p>
                  </div>
                </div>
                <div className="container">
                  <div className="content">
                    ...
                    <p>Click on the technology names to filter the blips on the radar and learn more about the technology.</p>
                    <Image m={5} src={DisasterDropdown}/>
                    <p>Click on the dropdown lists in different specifications and select options to filter the radar further.</p>
                  </div>
                </div>
                <div className="container">
                  <div className="content">
                    ...
                    <p>Click on each of the phases on each corner of the radar to focus on them.</p>
                  </div>
                </div>
                <div className="container">
                  <div className="content">
