...
import { Button,Box, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, DrawerFooter, useDisclosure  } from '@chakra-ui/react';
...
export const FilterDrawer: React.FC = () => {
    ...
    return (
        <>
        {
             (window.screen.width > 728) ? <><CustomFilter /> <TechList /></> : 
             <>
